  ...
  const handleFileUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    if (event.target.files) {
      ...
      if (!isPaidTier && files.length + newFiles.length > 3) {
        alert(
          "Le niveau gratuit est limité à 3 fichiers. Mettez à niveau pour en traiter plus !",
        );
        return;
      }
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Téléchargez, transcrivez et téléchargez avec la puissance de
            l&apos;IA
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto mb-12">
          <div className="flex justify-center items-center space-x-4 mb-8 hidden">
            <span
              className={`text-lg ${isPaidTier ? "text-gray-500" : "text-indigo-600 font-semibold"}`}
            >
              Niveau gratuit
            </span>
            <Switch
            ...
            />
            <span
              className={`text-lg ${isPaidTier ? "text-pink-600 font-semibold" : "text-gray-500"}`}
            >
              Niveau Pro
            </span>
          </div>
          ...
          <Card className="bg-white shadow-xl">
            <CardHeader className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white hidden">
              <CardTitle className="text-2xl">
                Transcripteur de Factures
              </CardTitle>
              <CardDescription className="text-indigo-100">
                Téléchargez des images de factures et obtenez des fichiers texte
                transcrits
              </CardDescription>
            </CardHeader>
                ...
                <div className="mt-6">
                  ...
                  <ul className="space-y-2">
                    {transcribedFiles.map((file, index) => (
                      <li
                        key={index}
                        className="flex flex-col bg-green-50 p-2 rounded"
                      >
            ...
            <CardFooter>
              <Button
                ...
                disabled={
                  files.length === 0 ||
                  isTranscribing ||
                  (!isPaidTier && files.length > 3)
                }
              >
                {isTranscribing
                  ? "Transcription en cours..."
                  : "Transcrire les factures"}
              </Button>
            </CardFooter>
          </Card>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-white shadow-xl">
              <CardHeader className="bg-gradient-to-r from-indigo-400 to-purple-500 text-white">
                ...
                <CardDescription className="text-indigo-100">
                  Parfait pour un usage occasionnel
                </CardDescription>
              </CardHeader>
              <CardContent className="pt-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-center text-gray-600">
                    ...
                    Jusqu&apos;à 3 fichiers par lot
                  </li>
                  <li className="flex items-center text-gray-600">
                    <Check className="h-5 w-5 text-green-500 mr-2" /> Précision
                    de transcription de base
                  </li>
                  <li className="flex items-center text-gray-600">
                    <Check className="h-5 w-5 text-green-500 mr-2" /> Support 24
                    heures sur 24
                  </li>
                </ul>
              </CardContent>
              <CardFooter>
                <Button
                  className="w-full border-indigo-500 text-indigo-500 hover:bg-indigo-50"
                  variant="outline"
                >
                  Plan actuel
                </Button>
            ...
            <Card className="bg-white shadow-xl">
              <CardHeader className="bg-gradient-to-r from-pink-500 to-purple-600 text-white">
                ...
                <CardDescription className="text-pink-100">
                  Pour les entreprises ayant des besoins élevés
                </CardDescription>
              </CardHeader>
              <CardContent className="pt-6">
                <p className="text-4xl font-bold mb-4 text-pink-600">
                  29€
                  <span className="text-lg font-normal text-gray-600">
                    /mois
                  </span>
                ...
                <ul className="space-y-2">
                  <li className="flex items-center text-gray-600">
                    <Check className="h-5 w-5 text-green-500 mr-2" /> Fichiers
                    illimités par lot
                  </li>
                  <li className="flex items-center text-gray-600">
                    <Check className="h-5 w-5 text-green-500 mr-2" /> Précision
                    avancée alimentée par l&apos;IA
                  </li>
                  <li className="flex items-center text-gray-600">
                    <Check className="h-5 w-5 text-green-500 mr-2" /> Support
                    prioritaire 24/7
                  </li>
                  <li className="flex items-center text-gray-600">
                    <Check className="h-5 w-5 text-green-500 mr-2" />{" "}
              ...
              <CardFooter>
                <Button className="w-full bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-sm text-gray-400">
                Transformation du traitement des factures avec une technologie
                d&apos;IA de pointe.
              </p>
            </div>
            <div>
